...
(function() {
  ...
  grammar = {
    ...
    Expression: [o('Value'), o('Invocation'), o('JsxFilter'), o('Code'), o('Operation'), o('Assign'), o('If'), o('Try'), o('While'), o('For'), o('Switch'), o('Class'), o('Throw'), o('Yield')],
    Yield: [
      o('YIELD', function() {
    ...
    JsxFilter: [
      o('Expression JSX_FILTER SimpleAssignable', function() {
        return new Call($3, [$1]);
      }), o('Expression JSX_FILTER SimpleAssignable JsxFilterAddtlArgs', function() {
        return new Call($3, [$1].concat($4));
      })
    ],
    JsxFilterAddtlArgs: [
      o('JsxFilterAddtlArgs JsxFilterAddtlArg', function() {
        return $1.concat($2);
      }), o('JsxFilterAddtlArg', function() {
        return [$1];
      })
    ],
    JsxFilterAddtlArg: [
      o('JSX_FILTER_ADDTL_ARG Expression', function() {
        return $2;
      })
    ],
    Super: [
    ...
    JsxHamlElement: [
      ...
      }), o('JSX_ELEMENT_NAME JSX_INLINE_INDICATOR', function() {
        return new JsxElement({
          name: $1,
          inline: 'both'
        });
      ...
      }), o('JSX_ELEMENT_NAME JsxElementShorthands JSX_INLINE_INDICATOR', function() {
        return new JsxElement({
          name: $1,
          shorthands: $2,
          inline: 'both'
      ...
      }), o('JSX_ELEMENT_NAME JsxAttributes JSX_INLINE_INDICATOR', function() {
        return new JsxElement({
          name: $1,
          attributes: $2,
          inline: 'both'
      ...
      }), o('JSX_ELEMENT_NAME JsxElementShorthands JsxAttributes JSX_INLINE_INDICATOR', function() {
        return new JsxElement({
          name: $1,
          shorthands: $2,
          attributes: $3,
      ...
      }), o('JSX_ELEMENT_NAME JsxAttributes JSX_INLINE_INDICATOR JSX_ELEMENT_BODY_START JsxElementChildren_', function() {
        return new JsxElement({
          name: $1,
          attributes: $2,
          children: $5,
      ...
      }), o('JSX_ELEMENT_NAME JsxElementShorthands JsxAttributes JSX_INLINE_INDICATOR JSX_ELEMENT_BODY_START JsxElementChildren_', function() {
        return new JsxElement({
          name: $1,
          shorthands: $2,
          attributes: $3,
      ...
      }), o('JSX_ELEMENT_NAME JSX_INLINE_INDICATOR JSX_ELEMENT_BODY_START JsxElementChildren_', function() {
        return new JsxElement({
          name: $1,
          children: $4,
          inline: 'both'
      ...
      }), o('JSX_ELEMENT_NAME JsxElementShorthands JSX_INLINE_INDICATOR JSX_ELEMENT_BODY_START JsxElementChildren_', function() {
        return new JsxElement({
          name: $1,
          shorthands: $2,
          children: $5,
    ...
    JsxElementShorthands: [
      ...
      }), o('JsxElementShorthandInterpretedClasses', function() {
        return {
          classes: $1
        };
      ...
      }), o('JsxElementShorthandId JsxElementShorthandInterpretedClasses', function() {
        return {
          classes: $2,
          id: $1
        };
      ...
      }), o('JsxElementShorthandInterpretedClasses JsxElementShorthandId', function() {
        return {
          classes: $1,
          id: $2
        };
    ...
    JsxElementShorthandInterpretedClasses: [
      o('JSX_CLASS_SHORTHAND_SYMBOL Arguments', function() {
        $2.isArgList = true;
        return $2;
      })
    ],
    ...
    JsxElementChild: [
      o('JSX_ELEMENT_CONTENT', function() {
        return $1;
      }), o('JSX_ELEMENT_INLINE_CONTENT', function() {
        return new JsxInlineContent($1);
      }), o('JsxElement', function() {
        return $1;
      }), o('JSX_INLINE_ELEMENT JsxElement', function() {
        $2.inline = true;
        return $2;
      }), o('JSX_IMMEDIATE_INLINE_ELEMENT JsxElement', function() {
        $2.inline = 'IMMEDIATE';
        return $2;
      }), o('{ Expression }', function() {
        return $2;
      }), o('JSX_INLINE_EXPRESSION_START Expression }', function() {
        $2.inline = true;
        return $2;
      }), o('JSX_INLINE_BOTH_EXPRESSION_START Expression }', function() {
        $2.inline = 'both';
        return $2;
      }), o('JSX_IMMEDIATE_INLINE_EXPRESSION_START Expression }', function() {
        $2.inline = 'IMMEDIATE';
        return $2;
      }), o('{ INDENT Expression OUTDENT }', function() {
        return $3;
      }), o('JSX_INLINE_EXPRESSION_START INDENT Expression OUTDENT }', function() {
        $3.inline = true;
        return $3;
      }), o('JSX_INLINE_BOTH_EXPRESSION_START INDENT Expression OUTDENT }', function() {
        $3.inline = 'both';
        return $3;
      }), o('JSX_IMMEDIATE_INLINE_EXPRESSION_START INDENT Expression OUTDENT }', function() {
        $3.inline = 'IMMEDIATE';
        return $3;
      })
    ],
  ...
  operators = [['left', '.', '?.', '::', '?::'], ['left', 'CALL_START', 'CALL_END'], ['nonassoc', '++', '--'], ['left', '?'], ['right', 'UNARY'], ['right', '**'], ['right', 'UNARY_MATH'], ['left', 'MATH'], ['left', '+', '-'], ['left', 'SHIFT'], ['left', 'RELATION'], ['left', 'COMPARE'], ['left', '&'], ['left', '^'], ['left', '|'], ['left', '&&'], ['left', '||'], ['left', 'BIN?'], ['left', 'JSX_FILTER_ADDTL_ARG'], ['left', 'JSX_FILTER'], ['nonassoc', 'INDENT', 'OUTDENT'], ['right', 'YIELD'], ['right', '=', ':', 'COMPOUND_ASSIGN', 'RETURN', 'THROW', 'EXTENDS'], ['right', 'FORIN', 'FOROF', 'FORFROM', 'BY', 'WHEN'], ['right', 'IF', 'ELSE', 'FOR', 'WHILE', 'UNTIL', 'LOOP', 'SUPER', 'CLASS', 'IMPORT', 'EXPORT'], ['left', 'POST_IF']];
