...
(function() {
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.matchJsxTagBody = function(arg) {
      var consumed, elementName, endTag, errorExpectedEndTag, followsNewline, followsWhitespace, indentedBody, justOutdented, numOutdents, originalIndent, outdentNext, popLevels, ref2, ref3;
      ...
      while (true) {
        ref2 = this.matchJsxElementIndentedChild({
          followsNewline: followsNewline,
          followsWhitespace: followsWhitespace,
          preserveWhitespace: !indentedBody
        }), popLevels = ref2.popLevels, followsWhitespace = ref2.trailingWhitespace;
        ...
        if (outdentNext) {
          ref3 = this.lineToken({
            ...
            noNewlines: true
          }), numOutdents = ref3.numOutdents, consumed = ref3.consumed;
          if (numOutdents > 1) {
            errorExpectedEndTag();
          }
    ...
    Lexer.prototype.matchJsxStartTag = function(arg) {
      var allowLeadingWhitespace, elementName, followsNewline, followsWhitespace, match, ref2, ret, selfClosed, tagOpener, tagRegex, token, topLevel;
      ref2 = arg != null ? arg : {}, allowLeadingWhitespace = ref2.allowLeadingWhitespace, topLevel = ref2.topLevel, followsNewline = ref2.followsNewline, followsWhitespace = ref2.followsWhitespace;
    ...
    Lexer.prototype.matchJsxHamlElement = function(arg) {
      var allowLeadingDotClass, allowLeadingWhitespace, elementName, elementRegex, followsNewline, followsWhitespace, match, matchedParenthesizedAttributes, openingTag, topLevel;
      allowLeadingWhitespace = arg.allowLeadingWhitespace, allowLeadingDotClass = arg.allowLeadingDotClass, topLevel = arg.topLevel, followsNewline = arg.followsNewline, followsWhitespace = arg.followsWhitespace;
    ...
    Lexer.prototype.matchJsxInlineIndicator = function() {
      var indicator, match;
    ...
    Lexer.prototype.matchJsxClassShorthand = function(opts) {
      var addImplicitElementName, allowLeadingWhitespace, close, column, index, isInterpreted, klass, line, match, nested, open, ref2, ref3, ref4, ref5, regex, symbol;
      if (opts == null) {
        opts = {};
      }
      addImplicitElementName = opts.addImplicitElementName, allowLeadingWhitespace = opts.allowLeadingWhitespace;
    ...
    Lexer.prototype.matchJsxIndentedBody = function(arg) {
      var consumed, elementName, followsNewline, followsWhitespace, numOutdents, popLevels, ref2, ref3, topLevel;
    ...
    Lexer.prototype.matchJsxInlineBody = function(arg) {
      var alreadyStarted, close, column, consumedWhitespace, content, elementName, endOfExpressionOffset, equals, expression, full, index, line, match, matchedTag, nested, open, ref2, ref3, ref4, ref5, ref6, ref7, ref8, selfClosed, startBody;
      ...
      while (true) {
        ...
        if (matchedTag = this.matchJsxStartTag()) {
          elementName = matchedTag.elementName, selfClosed = matchedTag.selfClosed;
          if (!selfClosed) {
            this.matchJsxTagBody({
              elementName: elementName
            });
          }
    ...
    Lexer.prototype.matchJsxElementIndentedChild = function(opts) {
      var followsNewline, followsWhitespace, preserveWhitespace, ref2, ref3;
      followsNewline = opts.followsNewline, followsWhitespace = opts.followsWhitespace, preserveWhitespace = opts.preserveWhitespace;
    ...
    Lexer.prototype.offsetOfNextOutdent = function(greaterThan) {
      var column, error, full, line, match, offsetOfNextNewline, ref2, unclosed;
      if (greaterThan == null) {
        greaterThan = false;
      }
      if (!greaterThan) {
        offsetOfNextNewline = (function(_this) {
          return function() {
            var full, match, nonNewlines;
            if (!(match = /^([^\n]*)\n/.exec(_this.chunk))) {
              return;
            }
            full = match[0], nonNewlines = match[1];
        ...
        if (offsetOfNextNewline) {
          ref2 = this.getLineAndColumnFromChunk(0), line = ref2[0], column = ref2[1];
          try {
            new Lexer().tokenize(this.chunk.slice(0, offsetOfNextNewline), {
              line: line,
              column: column
            });
          } catch (error1) {
    ...
    Lexer.prototype.matchJsxElementIndentedExpression = function(arg) {
      var close, column, endOfExpressionOffset, followsNewline, followsWhitespace, index, inline, leadingWhitespace, line, match, nested, open, preserveWhitespace, ref2, ref3, ref4, ref5, ref6, ref7, ref8;
      followsNewline = arg.followsNewline, followsWhitespace = arg.followsWhitespace, preserveWhitespace = arg.preserveWhitespace;
    ...
    Lexer.prototype.matchJsxElementIndentedContentLine = function(arg) {
      var content, followsNewline, match, preserveWhitespace, ref2, trailingWhitespace;
      preserveWhitespace = arg.preserveWhitespace, followsNewline = arg.followsNewline;
    ...
    Lexer.prototype.lineToken = function(opts) {
      var action, diff, dry, includesBlankLine, indent, match, noNewlines, numOutdents, returnNumOutdents, size, token;
      if (opts == null) {
        opts = {};
      }
      ...
      if (noNewlines == null) {
        noNewlines = this.unfinished({
          includesBlankLine: includesBlankLine
        });
      }
      switch (action) {
        case 'consumedIndebt':
    ...
    Lexer.prototype.newlineToken = function(offset, opts) {
      var token;
      if (opts == null) {
        opts = {};
      }
    ...
    Lexer.prototype.unfinished = function(opts) {
      var ref2, regex;
      if (opts == null) {
        opts = {};
      }
    ...
    Lexer.prototype.jsxLeadingDotClassAllowed = function(arg) {
      var includesBlankLine, prevToken, ref2, ref3;
      includesBlankLine = (arg != null ? arg : {}).includesBlankLine;
      if (!this.tokens.length) {
        return true;
      }
      if (includesBlankLine) {
      ...
      ref3 = this.tokens, prevToken = ref3[ref3.length - 1];
    ...
    Lexer.prototype.prevLineStartsWith = function(tags, opts) {
      var index, lineStarter, offset, ref2, ref3, ref4, tag;
      if (opts == null) {
        opts = {};
      }
      offset = (ref2 = opts.offset) != null ? ref2 : 0;
      index = this.tokens.length - offset;
      while (tag = (ref3 = this.tokens[--index]) != null ? ref3[0] : void 0) {
        if (tag === 'TERMINATOR' || tag === 'INDENT' || tag === 'OUTDENT') {
          break;
        }
      }
      lineStarter = this.tokens[index + 1];
      return ref4 = lineStarter != null ? lineStarter[0] : void 0, indexOf.call(tags, ref4) >= 0;
    };
