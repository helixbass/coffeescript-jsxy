...
(function() {
  ...
  exports.Lexer = Lexer = (function() {
    ...
    Lexer.prototype.offsetOfNextOutdent = function(greaterThan) {
      var column, line, match, offsetOfNextNewline, ref2, unclosed;
      if (greaterThan == null) {
        greaterThan = false;
      }
      if (!greaterThan) {
        ...
        if (offsetOfNextNewline) {
          ref2 = this.getLineAndColumnFromChunk(0), line = ref2[0], column = ref2[1];
          unclosed = new Lexer().tokenize(this.chunk.slice(0, offsetOfNextNewline), {
            line: line,
            column: column,
            returnUnclosed: true
          });
