        ...
        return function() {
          ...
          compiled = flatten((function() {
            ...
            for (j = 0, len1 = ref5.length; j < len1; j++) {
              child = ref5[j];
              results.push([this.makeCode("\n" + idt)].concat(slice.call((isString(child) ? [this.makeCode(child)] : child instanceof JsxElement ? child.compileToFragments(o) : [this.makeCode('{'), child.compileToFragments(o), this.makeCode('}')]))));
            }
            return results;
          }).call(_this));
          return compiled;
