...
(function() {
  ...
  exports.StringLiteral = StringLiteral = (function(superClass1) {
    ...
    StringLiteral.prototype.compileNode = function(o) {
      if (this.jsxAttributeName) {
        return [this.makeCode(this.unquote())];
      } else {
        return StringLiteral.__super__.compileNode.call(this);
      }
    };

    StringLiteral.prototype.unquote = function() {
  ...
  exports.JsxElement = JsxElement = (function(superClass1) {
    ...
    function JsxElement(options) {
      var base1, base2, ref3, ref4, ref5;
      JsxElement.__super__.constructor.call(this);
      this.name = options.name, this.children_ = (ref3 = options.children) != null ? ref3 : [], this.attributes = (ref4 = options.attributes) != null ? ref4 : {}, this.shorthands = (ref5 = options.shorthands) != null ? ref5 : {}, this.inline = options.inline;
    ...
    JsxElement.prototype.compileNode = function(o) {
      var compiledChildren, compiledClassAttribute, compiledIdAttribute, compiledListAttributes, compiledObjectAttributes, endTag, idt, initialIndent, isString, ref3, ref4, startTag;
      ...
      compiledClassAttribute = (function(_this) {
        return function() {
          var base1, classes;
          classes = _this.shorthands.classes;
          if (!classes.length) {
            return [];
          }
          ...
          if ((base1 = _this.attributes).object == null) {
            base1.object = new JsxAttributesObj;
          }
          _this.attributes.object.properties.push(new Assign(new Value(new IdentifierLiteral('className')), new Call(new Value(new IdentifierLiteral('classNames')), classes), 'object', new Literal(':')));
          return [];
        };
      })(this)();
      ...
      compiledChildren = (function(_this) {
        return function() {
          ...
          compiled = flatten((function() {
            ...
            ref5 = this.children_;
            results = [];
            for (index = j = 0, len1 = ref5.length; j < len1; index = ++j) {
              child = ref5[index];
              results.push([this.makeCode(this.inlineTagBody ? '' : child.inline && index ? child.inline === 'IMMEDIATE' ? '' : ' ' : index && this.children_[index - 1].inline === 'both' ? ' ' : "\n" + idt)].concat(slice.call((isString(child) ? [this.makeCode(child)] : child instanceof JsxInlineContent ? [this.makeCode(child.str)] : child instanceof JsxElement ? child.compileToFragments(o) : [this.makeCode('{'), child.compileToFragments(o), this.makeCode('}')]))));
            }
            return results;
          }).call(_this));
          return compiled;
  ...
  exports.JsxInlineContent = JsxInlineContent = (function(superClass1) {
    extend1(JsxInlineContent, superClass1);

    function JsxInlineContent(str) {
      this.str = str;
      JsxInlineContent.__super__.constructor.call(this);
      this.inline = 'IMMEDIATE';
    }

    return JsxInlineContent;
