...
(function() {
  ...
  grammar = {
    ...
    Expression: [o('Value'), o('JsxFilter'), o('Code'), o('Operation'), o('Assign'), o('If'), o('Try'), o('While'), o('For'), o('Switch'), o('Class'), o('Throw'), o('Yield')],
    Yield: [
      o('YIELD',
      function() {
        return new Op($1,
    ...
    JsxFilter: [
      o('Expression JSX_FILTER SimpleAssignable',
      function() {
        return new Call($3,
      [$1]);
      }),
      o('Expression JSX_FILTER SimpleAssignable JsxFilterAddtlArgs',
      function() {
        return new Call($3,
      [$1].concat($4));
      })
    ...
    JsxFilterAddtlArgs: [
      o('JsxFilterAddtlArgs JsxFilterAddtlArg',
      function() {
        return $1.concat($2);
      }),
      o('JsxFilterAddtlArg',
    ...
    JsxFilterAddtlArg: [
      o('JSX_FILTER_ADDTL_ARG Expression',
      function() {
        return $2;
      })
    ],
    ...
    JsxTag: [
      o('JsxStartTag JSX_ELEMENT_BODY_START JsxTagChildren JSX_END_TAG',
      function() {
      ...
      o('JsxStartTag JSX_ELEMENT_BODY_START JSX_END_TAG',
      function() {
        return new JsxElement({
          name: $1.name,
          attributes: $1.attributes
    ...
    JsxStartTag: [
      o('JSX_START_TAG_START JSX_ELEMENT_NAME JSX_START_TAG_END',
      function() {
        return {
          name: $2
        };
      }),
      o('JSX_START_TAG_START JSX_ELEMENT_NAME JsxParenthesizedAttributes JSX_START_TAG_END',
      function() {
        return {
          name: $2,
          attributes: {
      ...
      o('JSX_START_TAG_START JSX_ELEMENT_NAME INDENT OUTDENT JSX_START_TAG_END',
      function() {
        return {
          name: $2,
          attributes: {
    ...
    JsxTagChildren: [
      ...
      o('INDENT JsxElementChildren OUTDENT',
      function() {
        return $2;
      })
    ],
    JsxHamlElement: [
      ...
      o('JSX_ELEMENT_NAME JSX_INLINE_INDICATOR',
      function() {
        return new JsxElement({
          name: $1,
          inline: 'both'
      ...
      o('JSX_ELEMENT_NAME JsxElementShorthands',
      function() {
        return new JsxElement({
          name: $1,
          shorthands: $2
      ...
      o('JSX_ELEMENT_NAME JsxElementShorthands JSX_INLINE_INDICATOR',
      function() {
        return new JsxElement({
          name: $1,
          shorthands: $2,
      ...
      o('JSX_ELEMENT_NAME JsxAttributes',
      function() {
        return new JsxElement({
          name: $1,
          attributes: $2
      ...
      o('JSX_ELEMENT_NAME JsxAttributes JSX_INLINE_INDICATOR',
      function() {
        return new JsxElement({
          name: $1,
          attributes: $2,
      ...
      o('JSX_ELEMENT_NAME JsxElementShorthands JsxAttributes',
      function() {
        return new JsxElement({
          name: $1,
          shorthands: $2,
      ...
      o('JSX_ELEMENT_NAME JsxElementShorthands JsxAttributes JSX_INLINE_INDICATOR',
      function() {
        return new JsxElement({
          name: $1,
          shorthands: $2,
      ...
      o('JSX_ELEMENT_NAME JsxAttributes JSX_ELEMENT_BODY_START JsxElementChildren_',
      function() {
        return new JsxElement({
          name: $1,
          attributes: $2,
      ...
      o('JSX_ELEMENT_NAME JsxAttributes JSX_INLINE_INDICATOR JSX_ELEMENT_BODY_START JsxElementChildren_',
      function() {
        return new JsxElement({
          name: $1,
          attributes: $2,
      ...
      o('JSX_ELEMENT_NAME JsxElementShorthands JsxAttributes JSX_ELEMENT_BODY_START JsxElementChildren_',
      function() {
        return new JsxElement({
          name: $1,
          shorthands: $2,
      ...
      o('JSX_ELEMENT_NAME JsxElementShorthands JsxAttributes JSX_INLINE_INDICATOR JSX_ELEMENT_BODY_START JsxElementChildren_',
      function() {
        return new JsxElement({
          name: $1,
          shorthands: $2,
      ...
      o('JSX_ELEMENT_NAME JSX_ELEMENT_BODY_START JsxElementChildren_',
      function() {
        return new JsxElement({
          name: $1,
          children: $3
      ...
      o('JSX_ELEMENT_NAME JSX_INLINE_INDICATOR JSX_ELEMENT_BODY_START JsxElementChildren_',
      function() {
        return new JsxElement({
          name: $1,
          children: $4,
      ...
      o('JSX_ELEMENT_NAME JsxElementShorthands JSX_ELEMENT_BODY_START JsxElementChildren_',
      function() {
        return new JsxElement({
          name: $1,
          shorthands: $2,
      ...
      o('JSX_ELEMENT_NAME JsxElementShorthands JSX_INLINE_INDICATOR JSX_ELEMENT_BODY_START JsxElementChildren_',
      function() {
        return new JsxElement({
          name: $1,
          shorthands: $2,
    ...
    JsxElementShorthands: [
      o('JsxElementShorthandClasses',
      function() {
        return {
          classes: $1
        };
      }),
      o('JsxElementShorthandId',
      function() {
        return {
          id: $1
        };
      }),
      o('JsxElementShorthandId JsxElementShorthandClasses',
      function() {
        return {
          classes: $2,
          id: $1
      ...
      o('JsxElementShorthandClasses JsxElementShorthandId JsxElementShorthandClasses',
      function() {
        return {
          classes: $1.concat($2),
          id: $2
      ...
      o('JsxElementShorthandClasses JsxElementShorthandId',
      function() {
        return {
          classes: $1,
          id: $2
    ...
    JsxElementShorthandId: [
      o('JSX_ID_SHORTHAND_SYMBOL JSX_ID_SHORTHAND',
      function() {
        return $2;
      })
    ],
    JsxElementShorthandClasses: [
      o('JsxElementShorthandClass',
      function() {
        return [$1];
      }),
      o('JsxElementShorthandClasses JsxElementShorthandClass',
      function() {
        return $1.concat([$2]);
      })
    ],
    JsxElementShorthandClass: [
      o('JSX_CLASS_SHORTHAND_SYMBOL JSX_CLASS_SHORTHAND',
      function() {
        return $2;
      }),
      o('JSX_CLASS_SHORTHAND_SYMBOL Arguments',
      function() {
        return $2;
      }),
      o('JSX_CLASS_SHORTHAND_SYMBOL Array',
      function() {
        return $2;
      })
    ],
    JsxAttributes: [
      ...
      o('JsxParenthesizedAttributes_ JsxObjectAttributes_',
      function() {
        return {
          list: $1,
          object: $2
      ...
      o('JsxObjectAttributes_ JsxParenthesizedAttributes_',
      function() {
        return {
          list: $2,
          object: $1
    ...
    JsxParenthesizedAttributes_: [
      o('JSX_PARENTHESIZED_ATTRIBUTES_START JsxParenthesizedAttributes JSX_PARENTHESIZED_ATTRIBUTES_END',
      function() {
        return $2;
      })
    ],
    JsxParenthesizedAttributes: [
      o('JsxParenthesizedAttribute',
      function() {
        return [$1];
      }),
      o('JsxParenthesizedAttributes JsxParenthesizedAttribute',
      function() {
        return $1.concat($2);
      }),
      o('INDENT JsxParenthesizedAttributes OUTDENT',
      function() {
        return $2;
      }),
      o('JsxParenthesizedAttributes TERMINATOR',
      function() {
        return $1;
      }),
      o('JsxParenthesizedAttributes INDENT JsxParenthesizedAttributes OUTDENT',
      function() {
        return $1.concat($3);
      })
    ],
    JsxParenthesizedAttribute: [
      o('JSX_ATTRIBUTE_NAME = JsxParenthesizedAttributeValue',
      function() {
        return {
          name: $1,
          value: $3
    ...
    JsxObjectAttributes_: [
      o('JSX_OBJECT_ATTRIBUTES_START JsxAttributesObject JSX_OBJECT_ATTRIBUTES_END',
      function() {
        return $2;
      })
    ],
    JsxAttributesObject: [
      o('{ AssignList OptComma }',
      function() {
        return new JsxAttributesObj($2,
      $1.generated);
      })
    ],
    JsxElementChildren_: [
      o('JsxElementChildren JSX_ELEMENT_INLINE_BODY_END',
      function() {
        return $1;
      }),
      o('INDENT JsxElementChildren OUTDENT',
    ...
    JsxElementChildren: [
      ...
      o('JsxElementChildren JsxElementChild',
      function() {
        return $1.concat($2);
      })
    ],
    JsxElementChild: [
      o('JSX_ELEMENT_CONTENT',
      function() {
        return new JsxContent($1);
      }),
      o('JSX_ELEMENT_INLINE_CONTENT',
      function() {
        return new JsxInlineContent($1);
      }),
      o('JsxElement',
      function() {
        return $1;
      }),
      o('JSX_INLINE_ELEMENT JsxElement',
      function() {
        $2.inline = true;
        return $2;
      }),
      o('JSX_IMMEDIATE_INLINE_ELEMENT JsxElement',
      function() {
        $2.inline = 'IMMEDIATE';
        return $2;
      }),
      ...
      o('JSX_INLINE_EXPRESSION_START Expression }',
      function() {
        $2.inline = true;
        return $2;
      }),
      o('JSX_INLINE_BOTH_EXPRESSION_START Expression }',
      function() {
        $2.inline = 'both';
        return $2;
      }),
      o('JSX_IMMEDIATE_INLINE_EXPRESSION_START Expression }',
      function() {
        $2.inline = 'IMMEDIATE';
        return $2;
      }),
      ...
      o('JSX_INLINE_EXPRESSION_START INDENT Expression OUTDENT }',
      function() {
        $3.inline = true;
        return $3;
      }),
      o('JSX_INLINE_BOTH_EXPRESSION_START INDENT Expression OUTDENT }',
      function() {
        $3.inline = 'both';
        return $3;
      }),
      o('JSX_IMMEDIATE_INLINE_EXPRESSION_START INDENT Expression OUTDENT }',
      function() {
        $3.inline = 'IMMEDIATE';
        return $3;
      })
