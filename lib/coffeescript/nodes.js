    ...
    class JsxElement extends Base {
      ...
      compileNode(o) {
        ...
        compiledClassAttribute = (() => {
          ...
          this.attributes.object.properties.push(new Assign(new Value(new IdentifierLiteral('className')), new Call(new Value(new IdentifierLiteral('classNames')), classes), 'object', new Literal(':')));
          return [];
        })();
