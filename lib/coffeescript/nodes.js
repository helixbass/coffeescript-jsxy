...
(function() {
  ...
  exports.JsxElement = JsxElement = class JsxElement extends Base {
    ...
    compileNode(o) {
      var compiledChildren, compiledClassAttribute, compiledIdAttribute, compiledListAttributes, compiledObjectAttributes, endTag, isString, ref1, ref2, startTag;
      compiledIdAttribute = (() => {
      ...
      compiledChildren = (() => {
        var child, compiled, initialSpace;
        ...
        compiled = flatten((function() {
          ...
          for (j = 0, len1 = ref3.length; j < len1; j++) {
            child = ref3[j];
            results1.push([this.makeCode(' '), ...(isString(child) ? [this.makeCode(child)] : child instanceof JsxElement ? child.compileToFragments(o) : [this.makeCode('{'), child.compileToFragments(o), this.makeCode('}')])]);
          }
          return results1;
        }).call(this));
