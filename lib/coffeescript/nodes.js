    ...
    class JsxElement extends Base {
      ...
      compileNode(o) {
        ...
        compiledClassAttribute = (() => {
          var _extends, classes, combined, hasInterpretedClasses, j, klass, len1, styleShorthand;
          ...
          if (styleShorthand != null) {
            ...
            (this.objAttributes != null ? this.objAttributes : this.objAttributes = new JsxAttributesObj).properties.push(new Assign(new Value(new IdentifierLiteral('style')), styleShorthand.objects.length > 1 ? (_extends = new Value(new Literal(utility('_extends', o))), new Call(_extends, [new Obj, ...styleShorthand.objects])) : styleShorthand.objects[0], 'object', new Literal(':')));
          }
          if (!classes.length) {
            return [];
          }
