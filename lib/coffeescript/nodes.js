...
(function() {
  ...
  exports.JsxElement = JsxElement = (function() {
    class JsxElement extends Base {
      ...
      compileNode(o) {
        ...
        compiledClassAttribute = (() => {
          var base1, classes, combined, hasInterpretedClasses, j, klass, len1;
          ...
          if ((base1 = this.attributes).object == null) {
            base1.object = new JsxAttributesObj;
          }
          this.attributes.object.properties.push(new Assign(new Value(new IdentifierLiteral('className')), new Call(new Value(new IdentifierLiteral('classNames')), combined), 'object', new Literal(':')));
          return [];
        })();
        compiledListAttributes = (() => {
          var attr, j, len1, name, ref1, value;
          if (!this.attributes.list.length) {
            return [];
          }
          attr = [];
          ref1 = this.attributes.list;
          for (j = 0, len1 = ref1.length; j < len1; j++) {
            ({name, value} = ref1[j]);
        ...
        compiledObjectAttributes = (ref1 = (ref2 = this.attributes.object) != null ? typeof ref2.compileToFragments === "function" ? ref2.compileToFragments(o) : void 0 : void 0) != null ? ref1 : [];
    ...
    JsxElement.prototype.children = ['children_'];
