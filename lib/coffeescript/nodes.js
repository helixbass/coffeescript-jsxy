      ...
      compiledChildren = (() => {
        ...
        compiled = flatten((function() {
          ...
          for (j = 0, len1 = ref3.length; j < len1; j++) {
            child = ref3[j];
            results.push([this.makeCode(' '), ...(isString(child) ? [this.makeCode(child)] : child instanceof JsxElement ? child.compileToFragments(o) : [this.makeCode('{'), child.compileToFragments(o), this.makeCode('}')])]);
          }
          return results;
        }).call(this));
