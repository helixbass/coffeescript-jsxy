...
(function() {
  ...
  exports.JsxElement = JsxElement = class JsxElement extends Base {
    ...
    compileNode(o) {
      ...
      compiledChildren = (() => {
        ...
        compiled = flatten((function() {
          ...
          for (j = 0, len1 = ref3.length; j < len1; j++) {
            child = ref3[j];
            results1.push([this.makeCode(`\n${idt}`), ...(isString(child) ? [this.makeCode(child)] : child instanceof JsxElement ? child.compileToFragments(o) : [this.makeCode('{'), child.compileToFragments(o), this.makeCode('}')])]);
          }
          return results1;
        }).call(this));
        return compiled;
      ...
      idt = initialIndent;
      endTag = [this.makeCode(`\n${idt}`), this.makeCode('</'), this.makeCode(this.name), this.makeCode('>')];
