// Generated by CoffeeScript 0.1.5
(function() {
      ...
      generateJsxImports(o) {
        ...
        this.traverseChildren(true, (child) => {
          ...
          if (child.shorthands.classes.some(function(klass) {
            ...
            return jsxImports.push({
              importDefault: 'classNames',
              from: 'classnames'
            });
          }
        });
  ...
  exports.StringLiteral = StringLiteral = class StringLiteral extends Literal {
    compileNode(o) {
      if (this.jsxAttributeName) {
        return [this.makeCode(this.unquote())];
      } else {
    ...
    class JsxElement extends Base {
      ...
      compileNode(o) {
        ...
        compiledClassAttribute = (() => {
          var classes, combined, hasInterpretedClasses, j, klass, len1, styleShorthand;
          ...
          if (styleShorthand != null) {
            ...
            (this.objAttributes != null ? this.objAttributes : this.objAttributes = new JsxAttributesObj).properties.push(new Assign(new Value(new IdentifierLiteral('style')), styleShorthand.objects.length > 1 ? styleShorthand : styleShorthand.objects[0], 'object', new Literal(':'))); // TODO: how to handle this for React (ie non-React-Native)? translate to "cascading" Object.assign()?
          }
          if (!classes.length) {
            return [];
          }
          if (!hasInterpretedClasses) {
            return [this.makeCode(` className='${classes.join(' ')}'`)];
          }
          combined = [];
          for (j = 0, len1 = classes.length; j < len1; j++) {
            klass = classes[j];
          ...
          (this.objAttributes != null ? this.objAttributes : this.objAttributes = new JsxAttributesObj).properties.push(new Assign(new Value(new IdentifierLiteral('className')), new Call(new Value(new IdentifierLiteral('classNames')), combined), 'object', new Literal(':')));
          return [];
        })();
  ...
  exports.StringWithInterpolations = StringWithInterpolations = (function() {
    class StringWithInterpolations extends Base {
      ...
      compileNode(o) {
        var code, element, elements, expr, fragments, j, len1, salvagedComments, value;
