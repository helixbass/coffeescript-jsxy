...
(function() {
  ...
  exports.JsxElement = JsxElement = class JsxElement extends Base {
    constructor(options) {
      var base1, base2;
      super();
      ({
      ...
      compiledChildren = (() => {
        ...
        compiled = flatten((function() {
          ...
          for (index = j = 0, len1 = ref3.length; j < len1; index = ++j) {
            child = ref3[index];
            results1.push([this.makeCode(this.inlineTagBody ? '' : child.inline && index ? child.inline === 'IMMEDIATE' ? '' : ' ' : index && this.children_[index - 1].inline === 'both' ? ' ' : `\n${idt}`), ...(isString(child) ? [this.makeCode(child)] : child instanceof JsxInlineContent ? [this.makeCode(child.str)] : child instanceof JsxElement ? child.compileToFragments(o) : [this.makeCode('{'), child.compileToFragments(o), this.makeCode('}')])]);
          }
          return results1;
        }).call(this));
        return compiled;
