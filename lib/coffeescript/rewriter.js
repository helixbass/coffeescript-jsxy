...
(function() {
  ...
  BALANCED_PAIRS = [['(', ')'], ['[', ']'], ['{', '}'], ['JSX_INLINE_EXPRESSION_START', '}'], ['JSX_IMMEDIATE_INLINE_EXPRESSION_START', '}'], ['JSX_INLINE_BOTH_EXPRESSION_START', '}'], ['INDENT', 'OUTDENT'], ['CALL_START', 'CALL_END'], ['PARAM_START', 'PARAM_END'], ['INDEX_START', 'INDEX_END'], ['STRING_START', 'STRING_END'], ['REGEX_START', 'REGEX_END']];
  ...
  IMPLICIT_CALL = ['IDENTIFIER', 'PROPERTY', 'NUMBER', 'INFINITY', 'NAN', 'STRING', 'STRING_START', 'REGEX', 'REGEX_START', 'JS', 'NEW', 'PARAM_START', 'CLASS', 'IF', 'TRY', 'SWITCH', 'THIS', 'UNDEFINED', 'NULL', 'BOOL', 'UNARY', 'YIELD', 'AWAIT', 'UNARY_MATH', 'SUPER', 'THROW', '@', '->', '=>', '[', '(', '{', '--', '++', 'JSX_START_TAG_START', 'JSX_ELEMENT_NAME'];
