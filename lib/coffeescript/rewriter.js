...
(function() {
  ...
  BALANCED_PAIRS = [['(', ')'], ['[', ']'], ['{', '}'], ['JSX_INLINE_EXPRESSION_START', '}'], ['JSX_IMMEDIATE_INLINE_EXPRESSION_START', '}'], ['INDENT', 'OUTDENT'], ['CALL_START', 'CALL_END'], ['PARAM_START', 'PARAM_END'], ['INDEX_START', 'INDEX_END'], ['STRING_START', 'STRING_END'], ['REGEX_START', 'REGEX_END']];
